...
import { LegendType, ModelPhysicalQuantity, StressType } from '@/types/ModelCommonTypes'
  ...
  extraReducers: (builder) => {
    builder.addCase(
      ...
      (
        ...
        state.max = action.payload.stress.mises.max
        state.min = action.payload.stress.mises.min
